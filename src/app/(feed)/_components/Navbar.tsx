...
import { Search, Home, Users, Bell, MessageSquare, ChevronDown } from "lucide-react";
...
export default function Navbar() {
  return (
    <header className="h-[70px] border-b bg-background flex items-center px-6 sticky top-0 z-50">
      <div className="container w-full mx-auto flex items-center justify-between">
        
    
        <div className="flex items-center gap-2 cursor-pointer">
           <Image src="/images/logo.svg" alt="Fullstacl Logo" width={140} height={24} />
        </div>
        ...
        <div className="flex-1 max-w-xl px-10">
          <div className="relative group">
            ...
            <Input 
              ...
              className="pl-12 h-11 bg-muted/40 border-none rounded-full focus-visible:ring-1 focus-visible:ring-blue-500/50 transition-all"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3 pl-4 cursor-pointer group">
            ...
            <div className="flex items-center gap-1">
              <span className="text-sm font-semibold whitespace-nowrap">Dylan Field</span>
